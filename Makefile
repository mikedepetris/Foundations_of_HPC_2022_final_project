...
### BLIS library
BLISROOT=/u/dssc/mdepet00/mikeblis

cpu: sgemm_mkl.x sgemm_oblas.x dgemm_mkl.x dgemm_oblas.x sgemm_mkl_optimized.x sgemm_oblas_optimized.x dgemm_mkl_optimized.x dgemm_oblas_optimized.x sgemm_blis.x dgemm_blis.x
