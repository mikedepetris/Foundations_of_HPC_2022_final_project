...
gameoflife.x: gameoflife.h gameoflife.c read_write_pgm.h read_write_pgm.c initialize.c iterate_ordered.c iterate_static.c iterate_wave.c iterate_whiteblack.c
