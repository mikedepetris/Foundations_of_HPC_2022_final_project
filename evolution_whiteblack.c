...
void set_dead_or_alive_cell(const unsigned char *world, unsigned char *world_next, long world_size, long long int i) {
    ...
    printf("DEBUGB - set_dead_or_alive_cell 1 - i/world_size=%lld/%ld\n", i, world_size);
#endif
    // actual cell coordinates
    long x = i % world_size;
    long y = i / world_size;
#ifdef DEBUG_ADVANCED_B
    printf("DEBUGB - set_dead_or_alive_cell 2 - i/world_size=%03lld/%ld x=%03ld, y=%03ld\n", i, world_size, x, y);
#endif
    ...
    printf("DEBUGA - set_dead_or_alive_cell 3 - i/world_size=%03lld/%ld x=%03ld, y=%03ld sum=%d\n", i, world_size, x, y, sum);
#endif
